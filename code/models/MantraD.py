...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # configs.pred_len =  configs.label_len
        ...
        # self.URT_model  = MultiHeadURT(key_dim=self.flat_dim, query_dim=configs.batch_size*self.flat_dim, hid_dim=1024, temp=1, att="cosine", n_head=1)
        # self.URT_model  = MultiHeadURT(key_dim=self.pred_len , query_dim=self.pred_len*configs.enc_in, hid_dim=4096, temp=1, att="cosine", n_head=1)
