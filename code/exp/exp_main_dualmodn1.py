...
from models import Informer, Autoformer, AutoformerS1, Bautoformer, Uautoformer, UautoformerC1, UautoformerC2, Uautoformer2, Transformer, Reformer, Mantra, MantraA, MantraB, MantraD
...
class Exp_Main_DualmodN1(Exp_Basic):
    def __init__(self, args):
        super(Exp_Main_DualmodN1, self).__init__(args)

    def _build_model(self):
        model_dict = {
            'Autoformer': Autoformer,
            'AutoformerS1': AutoformerS1,
            # 'AutoformerS2': AutoformerS2,
